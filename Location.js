  ...
  return (
    <>
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.spaceBetweenRow}>
          <Text style={styles.monospaced}>
            {JSON.stringify(hasLocationPermission, null, 2)}
          </Text>
        </View>
      </View>
      ...
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.spaceBetweenRow}>
          <Text style={styles.monospaced}>
            {JSON.stringify(hasActivityIdentificationPermission, null, 2)}
          </Text>
        </View>
      </View>
    </>
  ...
  return (
    ...
    onPress={() => {
      ...
      /> */}
        ...
        <View style={styles.spaceBetweenRow}>
          <Text style={styles.monospaced}>
            {JSON.stringify(locationAvailable, null, 2)}
          </Text>
        </View>
      </View>
    </>
    ...
    <>
      <View style={styles.sectionContainer}>
        ...
        <View style={styles.centralizeContent}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => NativeModules.LocationUpdate.startService()}>
            <Text style={styles.instructions}>Start</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button}
            onPress={() => LocationUpdate.stopService()}>
...
const LocationEnhance = () => {
  ...
  const getNavigationState = useCallback(() => {
    HMSLocation.FusedLocation.Native.getNavigationContextState(
      ...
      .catch((ex) =>
        console.log('Error while getting navigation state. ' + ex),
      );
  });
...
const ActivityIdentification = () => {
  ...
  const createActivityIdentification = useCallback(() => {
    HMSLocation.ActivityIdentification.Native.createActivityIdentificationUpdates(
      ...
      .catch((err) =>
        console.log('ERROR: Activity identification failed', err),
      );
  }, []);
